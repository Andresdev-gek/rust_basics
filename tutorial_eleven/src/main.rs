...
// The impl keyword is primarily used
...
impl Education {
    ...
    fn constructing_education(college: &str, major: &str, minor: &str) -> Education {
        Education {
    ...
    // Methods - the first argument is
    // always &self which is the instance
...
fn main() {
    let mut education1 = Education::constructing_education("usvm", "Maths", "Geography");
    println!(
        "Education -> 
         College: {}. 
         Major: {}. 
    ...
    println!("Edu method -> {}", education1.full_education());
